    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">নতুন আইটেম যুক্ত করুন</h4></center>
            </div>
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            <div class="col-md-3" style="margin-top:7px;">
                                <label class="control-label">ঙ্খাবারের নাম:</label>
                            </div>
                            <div class="col-md-9">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> সেভ করুন</button>
                </form>
            </div>
        </div>
        <!-- /.modal-content -->
...
<div class="modal fade" id="addcategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center><h4 class="modal-title" id="myModalLabel">নতুন ক্যাটেগরি যোগ করুন</h4></center>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            <div class="col-md-3" style="margin-top:7px;">
                                <label class="control-label">ক্যাটেগরি নাম :</label>
                            </div>
                            <div class="col-md-9">
