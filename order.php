...
<div class="container">
	...
	<form method="POST" action="purchase.php">
		...
		<div class="row">
			<div class="col-md-3">
				<input type="text" name="customer" class="form-control" placeholder="আপনার নাম এবং মোবাইল নাম্বার দিন" required>
			</div>
			<div class="col-md-2" style="margin-left:-20px;">
				<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> ক্রয় করুন</button>
			</div>
		</div>
	</form>
</div>
